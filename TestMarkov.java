	...
	public static void main(String[] args) {
		...
		try {
			...
			if (markov.isValid() && equalArrays(m1.getData(), r1) && equalArrays(m2.getData(), r2) && equalArrays(m3.getData(), r3)) {
				...
				System.out.println("true"+equalArrays(m2.getData(), r2));
				System.out.println(equalArrays(m3.getData(), r3));
				System.out.println("Test 3 Failed");
				
			}
		} catch (Exception e) {
			System.out.println("Test 3 Failed oof");
		}
		...
		try {
			...
			System.out.println("Test 4 Failed off");
		}
