...
public class TestMatrixVector {
	...
	public static void main(String[] args) {
		...
		//		System.out.println(st1.trim());
				System.out.println(m1.toString().trim());
		...
		try {
			...
			if (m1.getNumRows() == 4 && m1.getNumCols() == 2 && m1.getData()[2][0] == 0.5 && m2.getNumRows() == 3 && m2.getNumCols() == 5 && m2.getData()[2][0] == 6.5) {
				...
				System.out.println(m1.getNumRows() == 4 && m1.getNumCols() == 2);
		...
		try {
			...
			System.out.println("Test 6 Failed off");
		}
		...
		try {
			...
			if (equalArrays(p1.getData(), p1Array) && equalArrays(p2.getData(), p2Array) && p3 == null) {
				...
				System.out.println("Tr"+equalArrays(p1.getData(), p1Array));
				System.out.println("TR"+equalArrays(p2.getData(), p2Array));
				System.out.println("null" + p3);
				
			}
		} catch (Exception e) {
			System.out.println("Test 7 Failed off");
		}
